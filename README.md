...
**현재 배포 후보: 0.7.3 검증판.** 0.7.3은 `AUTH-NOTIFY-001` P0-1~P0-4를 완료해 가입 완료·비밀번호 변경·탈퇴 접수·탈퇴 처리 완료 알림, 한국어 catalog, 메일 실패 시 상태 보존과 실패 감사를 제공한다. 실제 운영 인증서·다중 서버·운영 migration 승인은 [0.7.3 릴리스 문서](docs/RELEASE-0.7.3.md)의 환경 gate를 따른다.
