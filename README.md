...
**현재 개발 후보: 0.7.9.** 0.7.9는 승인된 `AUTH-UX-003`의 후속 브라우저·접근성·release gate와 Members 전용 `AUTH-UX-004` 타이포그래피 기준을 진행한다. 실제 운영 인증서·다중 서버·운영 migration 승인은 [0.7.8 릴리스 문서](docs/RELEASE-0.7.8.md)의 환경 gate를 따른다.
