...
<?php wp_body_open(); ?>
	<main class="kklidi-members-main">
		<section class="kklidi-members-card" aria-labelledby="kklidi-members-page-title">
			<header class="kklidi-members-header"><p class="kklidi-members-eyebrow"><?php echo esc_html(get_bloginfo('name')); ?></p><h1 id="kklidi-members-page-title"><?php esc_html_e('Log in', 'kklidi-members'); ?></h1><p><?php esc_html_e('Use your email or username and password to continue.', 'kklidi-members'); ?></p></header>
			...
			<nav class="kklidi-members-form-links" aria-label="<?php esc_attr_e('Login help', 'kklidi-members'); ?>"><a href="<?php echo esc_url($password_reset_url); ?>"><?php esc_html_e('Forgot your password?', 'kklidi-members'); ?></a><a href="<?php echo esc_url($register_url); ?>"><?php esc_html_e('Create an account', 'kklidi-members'); ?></a><a href="<?php echo esc_url($home_url); ?>"><?php esc_html_e('Back to site', 'kklidi-members'); ?></a></nav>
		</section>
	</main>
	<?php wp_footer(); ?>
</body>
