...
<head>
	...
	<title><?php esc_html_e('Log in', 'kklidi-members'); ?></title>
	<?php wp_head(); ?>
</head>
	...
	<main class="kklidi-members-main">
		<section class="kklidi-members-card" aria-labelledby="kklidi-members-page-title">
			...
			<form class="kklidi-members-form" method="post" action="<?php echo esc_url($action_url); ?>" data-kklidi-members-login>
				...
				<label class="kklidi-members-field" for="kklidi-members-identifier"><?php esc_html_e('Email', 'kklidi-members'); ?><input id="kklidi-members-identifier" name="kklidi_members_identifier" type="text" inputmode="email" autocomplete="username" value="<?php echo esc_attr($identifier); ?>" required<?php echo isset($field_errors['identifier']) ? ' aria-invalid="true" aria-describedby="kklidi-members-identifier-help kklidi-members-identifier-error"' : ' aria-describedby="kklidi-members-identifier-help"'; ?>><span class="kklidi-members-field-help" id="kklidi-members-identifier-help"><?php esc_html_e('Existing members may also use their existing username.', 'kklidi-members'); ?></span><?php if (isset($field_errors['identifier'])) : ?><span class="kklidi-members-field-error" id="kklidi-members-identifier-error"><?php echo esc_html($field_errors['identifier']); ?></span><?php endif; ?></label>
			...
			<?php $route_links = array(array('url' => $register_url, 'label' => __('Sign up', 'kklidi-members')), array('url' => $password_reset_url, 'label' => __('Find password', 'kklidi-members')), array('url' => $home_url, 'label' => __('Home', 'kklidi-members'))); require KKLIDI_MEMBERS_DIR . 'templates/partials/route-links.php'; ?>
		</section>
	</main>
	<?php wp_footer(); ?>
</body>
