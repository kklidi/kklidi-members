...
| D12 | **SPECIFIED FOR 0.7.19 2026-09-10** | `AUTH-MESSAGE-UX-001`: 보안·상태 문구는 gettext 기반 읽기 전용 catalog로 보여주고, 네 사용자 이메일은 Notifications에서 번역 기본 제목·본문을 명시적으로 표시. 전체 문구 editor, 새 message option, HTML과 관리자 가입 알림은 포함하지 않음 |
