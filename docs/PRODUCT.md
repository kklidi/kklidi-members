...
| D13 | **SPECIFIED FOR 0.7.20 2026-09-10** | `AUTH-ADMIN-NOTIFY-001`: 신규 가입 관리자 알림은 기본 꺼짐 opt-in. 활성 가입 완료 뒤 Core `admin_email`에 plain text로 1회 요청하고 실패는 가입을 rollback하지 않음. 승인제·복수/사용자 정의 수신자·HTML·SMTP·retry는 포함하지 않음 |
